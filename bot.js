...
client.on("message", message => {
 ...
 if (message.content === "^^help") {
  ...
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .addField("『Dream SYSTEM』 『اسم البوت』", true)
      
      .addField("『@SAJED   👻#8844 』『مصمم البوت』", true)
...
القسم الثالث مصمم البوت | @SAJED   👻#8844  
...
if (message.content === '^^support') {
      message.author.send(' |https://discord.gg/2AB7Aqt| لـ أي استفسار').catch(e => console.log(e.stack));
...
if (message.content === '^^invite') {
      message.author.send(' رابط البوت |  https://discordapp.com/oauth2/authorize?client_id=524246356991410186&scope=bot&permissions=2146958591 ').catch(e => console.log(e.stack));
